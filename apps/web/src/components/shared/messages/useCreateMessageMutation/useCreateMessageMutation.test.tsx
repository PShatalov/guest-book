...
describe('useCreateMessageMutation', () => {
  beforeEach(() => {
    mockApiFetchClient.mockReset();
  });

  it('invalidates message list queries after a successful create', async () => {
    ...
    result.current.mutate({ text: 'Hello', categoryTag: 'general' });
